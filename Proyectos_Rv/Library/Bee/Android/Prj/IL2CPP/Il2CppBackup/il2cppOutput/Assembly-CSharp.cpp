...
// Cambio_Carruse
struct Cambio_Carruse_t4E4309C6FED9874312725CAE1C88669175555E07;
// UnityEngine.Camera
...
// Giro_Imagenes
struct Giro_Imagenes_t8F2796A8170569B936C6D49788F2E3A4D30704F9;
...
// Cambio_Carruse
struct Cambio_Carruse_t4E4309C6FED9874312725CAE1C88669175555E07  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	// UnityEngine.Camera[] Cambio_Carruse::cameras
	CameraU5BU5D_t1506EBA524A07AD1066D6DD4D7DFC6721F1AC26B* ___cameras_4;
	// System.Int32 Cambio_Carruse::currentCameraIndex
	int32_t ___currentCameraIndex_5;
	// System.Single Cambio_Carruse::timerEspera
	float ___timerEspera_6;
	// System.Single Cambio_Carruse::reinicioContador
	float ___reinicioContador_7;
};
...
// Giro_Imagenes
struct Giro_Imagenes_t8F2796A8170569B936C6D49788F2E3A4D30704F9  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	// UnityEngine.Transform Giro_Imagenes::cameraTransform
	Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* ___cameraTransform_4;
	// System.Single Giro_Imagenes::rotationSpeed
	float ___rotationSpeed_5;
	// System.Boolean Giro_Imagenes::isRotating
...
// System.Void Cambio_Carruse::CambioCamara()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Cambio_Carruse_CambioCamara_m043E6E64379A127A8D32C1CAB2D88A858805D639 (Cambio_Carruse_t4E4309C6FED9874312725CAE1C88669175555E07* __this, const RuntimeMethod* method) ;
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Cambio_Carruse::Start()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Cambio_Carruse_Start_m36C44A08E9A90A9C98CE65941E4BCA90B74E05E5 (Cambio_Carruse_t4E4309C6FED9874312725CAE1C88669175555E07* __this, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
...
IL_0004:
	{
		...
		CameraU5BU5D_t1506EBA524A07AD1066D6DD4D7DFC6721F1AC26B* L_0 = __this->___cameras_4;
		int32_t L_1 = V_0;
		NullCheck(L_0);
		int32_t L_2 = L_1;
...
IL_0019:
	{
		// for (int i = 0; i < cameras.Length; i++)
		int32_t L_6 = V_0;
		CameraU5BU5D_t1506EBA524A07AD1066D6DD4D7DFC6721F1AC26B* L_7 = __this->___cameras_4;
		NullCheck(L_7);
...
// System.Void Cambio_Carruse::Update()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Cambio_Carruse_Update_mCEEE4FDDA5C7B223A8E8C87220C6BB4B69EE8E65 (Cambio_Carruse_t4E4309C6FED9874312725CAE1C88669175555E07* __this, const RuntimeMethod* method) 
{
	{
		// reinicioContador += Time.deltaTime;
		float L_0 = __this->___reinicioContador_7;
		float L_1;
		L_1 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		__this->___reinicioContador_7 = ((float)il2cpp_codegen_add(L_0, L_1));
		// if (reinicioContador >= timerEspera)
		float L_2 = __this->___reinicioContador_7;
		float L_3 = __this->___timerEspera_6;
	...
	{
		// CambioCamara();
		Cambio_Carruse_CambioCamara_m043E6E64379A127A8D32C1CAB2D88A858805D639(__this, NULL);
		// reinicioContador = 0.0f; // Reiniciar el contador de tiempo.
		__this->___reinicioContador_7 = (0.0f);
	}
...
{
	{
		...
		CameraU5BU5D_t1506EBA524A07AD1066D6DD4D7DFC6721F1AC26B* L_0 = __this->___cameras_4;
		int32_t L_1 = __this->___currentCameraIndex_5;
		NullCheck(L_0);
		int32_t L_2 = L_1;
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_3 = (L_0)->GetAt(static_cast<il2cpp_array_size_t>(L_2));
		NullCheck(L_3);
		...
		// currentCameraIndex++;
		int32_t L_4 = __this->___currentCameraIndex_5;
		__this->___currentCameraIndex_5 = ((int32_t)il2cpp_codegen_add(L_4, 1));
		// if (currentCameraIndex >= cameras.Length)
		int32_t L_5 = __this->___currentCameraIndex_5;
		CameraU5BU5D_t1506EBA524A07AD1066D6DD4D7DFC6721F1AC26B* L_6 = __this->___cameras_4;
		NullCheck(L_6);
	...
	}
	{
		...
		__this->___currentCameraIndex_5 = 0;
	}
...
IL_0038:
	{
		...
		CameraU5BU5D_t1506EBA524A07AD1066D6DD4D7DFC6721F1AC26B* L_7 = __this->___cameras_4;
		int32_t L_8 = __this->___currentCameraIndex_5;
		NullCheck(L_7);
		int32_t L_9 = L_8;
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_10 = (L_7)->GetAt(static_cast<il2cpp_array_size_t>(L_9));
		NullCheck(L_10);
...
// System.Void Cambio_Carruse::.ctor()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Cambio_Carruse__ctor_m0C9B5DCF8C48AA8A61F9325DC80589F2E72E44E2 (Cambio_Carruse_t4E4309C6FED9874312725CAE1C88669175555E07* __this, const RuntimeMethod* method) 
{
	{
		// public float timerEspera = 100.0f; // Tiempo entre cambios de c?mara en segundos.
		__this->___timerEspera_6 = (100.0f);
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Giro_Imagenes::Update()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Giro_Imagenes_Update_m7940F62DBF1853303FED941A4E0056D17D0D741E (Giro_Imagenes_t8F2796A8170569B936C6D49788F2E3A4D30704F9* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_3);
		Transform_RotateAround_m489C5BE8B8B15D0A5F4863DE6D23FF2CC8FA76C6(L_3, L_4, L_5, ((float)il2cpp_codegen_multiply(L_6, L_7)), NULL);
	}
...
// System.Void Giro_Imagenes::.ctor()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Giro_Imagenes__ctor_mA6E2A56839DEC41026EFFAE8EB7BCB39C7B4F6A2 (Giro_Imagenes_t8F2796A8170569B936C6D49788F2E3A4D30704F9* __this, const RuntimeMethod* method) 
{
	{
